...
/* harmony import */ var _modules_img_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/img-modal */ "./src/js/modules/img-modal.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_img_modal__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
...
var imgModal = function imgModal() {
  var trigger = document.querySelectorAll('.preview');
  trigger.forEach(function (elem) {
    elem.parentNode.addEventListener('click', function (e) {
      e.preventDefault();
      var hrefValue = elem.parentNode.getAttribute('href'),
          imgNum = +hrefValue.replace(/\D/g, ''),
          img = document.createElement('img'),
          imgBlock = document.createElement('div');
      img.setAttribute('src', "assets/img/our_works/big_img/".concat(imgNum, ".png"));
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var hideSelector = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : modalSelector;
    var trigger = document.querySelectorAll(triggerSelector),
        modal = document.querySelector(modalSelector);

    if (document.querySelector(closeSelector)) {
      var cross = document.querySelector(closeSelector);
...
var timer = function timer() {
  ...
  var deadline = new Date('09 01 2021');
  timer();
  ...
  function timer() {
    var currentDate = Date.now(),
        timeLeft = (deadline - currentDate) / 1000,
        // seconds
    dayLeft = Math.floor(timeLeft / 60 / 60 / 24),
        // days
    hourLeft = Math.floor((timeLeft - dayLeft * 24 * 60 * 60) / 60 / 60),
        // hours
    minuteLeft = Math.floor((timeLeft - dayLeft * 24 * 60 * 60 - hourLeft * 60 * 60) / 60),
        // minutes
